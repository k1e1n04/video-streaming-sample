...
export namespace video {
    export class UploadVideoRequest extends pb_1.Message {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): UploadVideoRequest {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new UploadVideoRequest();
    ...
    export class UploadVideoResponse extends pb_1.Message {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): UploadVideoResponse {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new UploadVideoResponse();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
    ...
    export class GetVideoResponse extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.presigned_url.length)
                writer.writeString(1, this.presigned_url);
            if (!w)
                return writer.getResultBuffer();
        }
    ...
    export class ListVideosRequest extends pb_1.Message {
        ...
        constructor(data?: any[] | ({
            ...
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
                if ("last_evaluated_key" in data && data.last_evaluated_key != undefined) {
    ...
    export class ListVideosResponse extends pb_1.Message {
        ...
        get videos() {
            return pb_1.Message.getRepeatedWrapperField(this, VideoInfo, 1) as VideoInfo[];
        }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.videos.length)
                writer.writeRepeatedMessage(1, this.videos, (item: VideoInfo) => item.serialize(writer));
            if (this.has_last_evaluated_key)
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): ListVideosResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.videos, () => pb_1.Message.addToRepeatedWrapperField(message, 1, VideoInfo.deserialize(reader), VideoInfo));
                        break;
                    case 2:
                        message.last_evaluated_key = reader.readString();
                        break;
    ...
    export abstract class UnimplementedVideoServiceService {
        static definition = {
            UploadVideo: {
                ...
                requestSerialize: (message: UploadVideoRequest) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => UploadVideoRequest.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: UploadVideoResponse) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => UploadVideoResponse.deserialize(new Uint8Array(bytes))
            },
            GetVideoURL: {
        ...
        abstract UploadVideo(call: grpc_1.ServerReadableStream<UploadVideoRequest, UploadVideoResponse>, callback: grpc_1.sendUnaryData<UploadVideoResponse>): void;
        abstract GetVideoURL(call: grpc_1.ServerUnaryCall<GetVideoRequest, GetVideoResponse>, callback: grpc_1.sendUnaryData<GetVideoResponse>): void;
    ...
    export class VideoServiceClient extends grpc_1.makeGenericClientConstructor(UnimplementedVideoServiceService.definition, "VideoService", {}) {
        constructor(address: string, credentials: grpc_1.ChannelCredentials, options?: Partial<grpc_1.ChannelOptions>) {
            super(address, credentials, options);
        }
        UploadVideo: GrpWritableServiceInterface<UploadVideoRequest, UploadVideoResponse> = (metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<UploadVideoResponse>, options?: grpc_1.CallOptions | grpc_1.requestCallback<UploadVideoResponse>, callback?: grpc_1.requestCallback<UploadVideoResponse>): grpc_1.ClientWritableStream<UploadVideoRequest> => {
            return super.UploadVideo(metadata, options, callback);
        };
        GetVideoURL: GrpcUnaryServiceInterface<GetVideoRequest, GetVideoResponse> = (message: GetVideoRequest, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<GetVideoResponse>, options?: grpc_1.CallOptions | grpc_1.requestCallback<GetVideoResponse>, callback?: grpc_1.requestCallback<GetVideoResponse>): grpc_1.ClientUnaryCall => {
